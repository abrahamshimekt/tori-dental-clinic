    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-gray-300 px-4 py-1.5 rounded-full text-sm font-medium mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-6">
            ...
            <span className="relative">
              <span className="text-gray-300">Addis Ababa</span>
              <svg
          ...
          {/* Subtext */}
          <p className="text-lg md:text-xl text-gray-100/80 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              href="#appointment"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-dental-blue text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:bg-dental-blue-dark transition-all shadow-2xl shadow-gray-500/30 hover:-translate-y-1 hover:shadow-gray-500/50"
            >
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-gray-400/60">
        <span className="text-xs font-medium tracking-widest uppercase">
          Scroll
        </span>
        <div className="w-5 h-8 border-2 border-gray-400/40 rounded-full flex justify-center pt-1">
